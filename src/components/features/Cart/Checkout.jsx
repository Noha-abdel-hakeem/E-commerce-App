...
function Checkout() {
  ...
  const validationSchema = Yup.object().shape({
    phone: Yup.string().required("Sorry, Your phone is required"),
    city: Yup.string().required("Sorry, Your city is required"),
    details: Yup.string().required("Sorry, Your address is required"),
  });
