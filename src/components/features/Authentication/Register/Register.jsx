...
function Register() {
  ...
  const validationSchema = Yup.object().shape({
    name: Yup.string("Your name must be a string")
      ...
      .max(30, "Your name can not be more than 30 character!")
      .required("Sorry, Your name is required !"),
    email: Yup.string("Your Email must be a string").email("Invalid Email").required("Sorry, Your Email is required !"),
    phone: Yup.string("Your phone must be a string")
      .matches(/^(\+2)?0(10|11|12|15)[0-9]{8}$/, "Invalid phone number, Please enter your egyptian number !")
